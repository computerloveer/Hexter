...
asp = ['admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','administracion/','instadmin/',
...
if code == "1":
	for item in php:
		print("[+] Checking  "+url+item)
		url_ex = urllib.urlopen(url+item)
		if url_ex.code == 200:
			print ("[+] Checking  "+url+item+"  <============[200]")
